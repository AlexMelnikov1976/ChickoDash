...
**Версия:** v3.36
**Дата обновления:** 22.04.2026, день-7, поздний вечер  
**Коммит:** 8ebef33 — Phase 2.8.2 закрыта: полная вкладка Menu Analysis (Kasavana-Smith)
**Focus:** AI кнопка re-enable, dish_sales pipeline fix, франчайзи пилот
...
## Следующие шаги — post Phase 2.8.2

**Приоритет 1:** Re-enable AI кнопки в UI (Phase 2.8.3). Backend `/api/ai-insight` готов, временно отключен для контроля расходов. Включить после стабилизации пилота.

**Приоритет 2:** Фикс пайплайна `dish_sales`. Данные заканчиваются 2025-11-20, нужно обновление до 2026 г. Влияет на актуальность menu analysis.
